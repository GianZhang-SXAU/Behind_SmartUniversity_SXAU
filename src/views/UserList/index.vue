      ...
      <a-form-item class="formSearch-item">
        <a-space>
          <a-button
            type="primary"
            shape="default"
            @click="CreateAndUpdateVisible(1)"
            >新增用户</a-button
          >
        </a-space>
      </a-form-item>
    ...
    >
      <template #bodyCell="{ column, record }">
        ...
        <template v-if="column.dataIndex === 'opera'">
          <a-space>
            <a-button type="link" @click="CreateAndUpdateVisible(0, record)"
              >修改</a-button
            >
