            ...
            <template>
                <div class="createTemplate">
                    <p class="title">{{ formData.id ? '修改' : '录入' }}线路规划</p><a-divider />
                    ...
                    <a-row :gutter="24">
                            ...
                            <a-col :span="12">
                                <a-form-item label="线路编号"  name="routenumbers">
                                    <a-input v-model:value="formData.routenumbers"
                                        placeholder="请输入线路编号"/>
                                </a-form-item>
                            </a-col>
                            ...
                            <a-col :span="12">
                                <a-form-item label="起始站"  name="initiatingstation">
                                    <a-input v-model:value="formData.initiatingstation"
                                        placeholder="请输入起始站"/>
                                </a-form-item>
                            </a-col>
                            ...
                            <a-col :span="12">
                                <a-form-item label="终点站"  name="terminal">
                                    <a-input v-model:value="formData.terminal"
                                        placeholder="请输入终点站"/>
                                </a-form-item>
                            </a-col>
                            ...
                            <a-col :span="12">
                                <a-form-item label="总长度"  name="totallength">
                                    <a-input v-model:value="formData.totallength"
                                        placeholder="请输入总长度"/>
                                </a-form-item>
                            </a-col>
            ...
            const route = useRoute();
                ...
                const OnSubmit = async (values) => {
                    ...
                    const { code } = await POST(`/routeplanning/${id != undefined ? "update" : "save"}`, data);
